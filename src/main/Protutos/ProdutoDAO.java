...
public class ProdutoDAO {
    ...
    // Construtor que inicia a conexão com o banco de dados
    ...
    public Produto consultarPorId(int id) {
        ...
        try (PreparedStatement stmt = CONEXAO_DB.prepareStatement(sql)) {
            ...
            System.out.println("Erro ao consultar o id do produto: " + e.getMessage());
        } return null;
    }
    ...
    // Metodo para excluir um produto específico
